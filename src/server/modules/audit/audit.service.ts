 ...
 *   AUTH_*, KYC_*, DEPOSIT_*, WITHDRAWAL_*, METAAPI_*, RISK_*, PLAN_*, ADMIN_*
 */
...
export const AUDIT = {
  ...
  METAAPI_ORDER_SUBMITTED: 'METAAPI_ORDER_SUBMITTED',
  METAAPI_ORDER_FILLED: 'METAAPI_ORDER_FILLED',
  METAAPI_ORDER_REJECTED: 'METAAPI_ORDER_REJECTED',
  METAAPI_POSITION_CLOSED: 'METAAPI_POSITION_CLOSED',
